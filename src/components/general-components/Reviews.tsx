      ...
      {totalReviews && (
        <div className="mt-4 w-full">
          <Dialog open={isDialogOpen} onOpenChange={onDialogOpenChange}>
            <DialogContent className="max-w-[95vw] md:max-w-5xl  max-h-[calc(100vh-5rem)] overflow-y-auto p-4 md:px-12">
              <div className="flex flex-col lg:flex-row gap-6 w-full">
                  ...
                  <ScrollArea className="h-64 md:h-96">
                    <div className="flex items-center gap-1 mt-2 px-4">
                      <div className="flex items-center gap-2 mb-6 md:mb-10">
                        <Star fill="black" className="w-6 h-6 md:w-8 md:h-8" />
                    ...
                    <div className="text-sm font-500 mr-6 mb-6 md:mb-20 px-4">
                      Overall rating
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                      {Object.entries(ratingCategories).map(
                        ([key, label], index) => (
                          <div
                            key={key}
                            className={`flex items-center px-4 mr-2 gap-4 w-full md:w-72 ${
                              index !==
                          ...
                          >
                            ...
                            <p className="text-xs md:text-sm font-500 flex-1">
                              {label}
                            </p>
                ...
                <div className="flex flex-col gap-6 w-full lg:w-2/3">
                  ...
                  <div className="relative w-full">
                    <div className="flex items-center border rounded-3xl p-2 shadow-sm w-full focus-within:border-black focus-within:border-2">
